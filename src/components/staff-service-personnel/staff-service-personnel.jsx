...
const brigadeMedicalPersonnelFilters = [
    ...
    <ReferenceInput source="staffId" label="Staff service personnel" reference="staff-service-personnel" allowEmpty>
        <SelectInput optionText="position" />
    </ReferenceInput>,
]

export const ServiceStaffList = props => {
...
export const ServiceStaffEdit = props => (
    <Edit {...props}>
        <SimpleForm>
...
export const ServiceStaffCreate = props => (
    <Create {...props}>
        <SimpleForm>             
            <TextInput source="firstName" />
            <TextInput source="surname" />
